...
def addition(question: str) -> dict | str:
    ...
    example = {
        "method": "addition",
        "scenario": "You're packing a picnic basket! You have some apples and then pick some more. Drag the apples to the basket to show the total.",
    ...
    response = client.models.generate_content(
        ...
        "VALIDATION:\n"
        "Return dictionary only. No markdown, no commentary.",
